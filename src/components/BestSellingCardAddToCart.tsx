...
const notify = () => toast.success("Product Added Successfully", {
  ...
  onClick={() => setcartItem({ ...cartItem, color: item })}
              ...
              className="group mt-5 w-full bg-gray-800 hover:bg-transparent text-white hover:text-gray-700 scroll-m-20 text-xs font-semibold tracking-tight rounded-xl  hover:shadow-lg ">
            <MdShoppingCart className="mr-2 w-4 h-4 group-hover:text-myOrange duration 300" />
            Add To Cart
          </Button>
          </div>
