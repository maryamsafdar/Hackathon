   ...
   return (
      <div className=' body-font mb-[100px] mt-[100px]'>
         ...
         <div className='mb-7 lg:mb-0 overflow-hidden z-10 mx-auto group relative'>
            <Link href={"/T-shirts"}>
               <Image src="/images/t-shirts/f451baa75283c687b74c0ad0469e1179.jpg" alt="t-shirts" width={200} height={200} className='rounded-xl duration-500 group-hover:scale-125 ' />
         ...
         <div className='mb-7 lg:mb-0 overflow-hidden z-10 mx-auto group relative'>
            <Link href={"/Coats"}>
               <Image src="/images/coat/Women's Blue Wool Trench Coat _ Trench Coat _ Wool Trench Coat.jpg" alt="coat" width={280} height={280} className='rounded-xl duration-500 group-hover:scale-125 ' />
